...
const Experience = () => {
  return (
    <div id='experience' className='flex flex-col w-[60rem] h-auto pt-10'>
  ...
  <div className="mb-10 ml-6 relative">
    ...
    <div className="bg-white p-4 rounded shadow-md">
      <p className="text-[#2D8BE8] font-semibold">2024-2025</p>
      <h3 className="font-bold text-lg">Locus 2025 Design Chief</h3>
      <p className="text-gray-600">Worked as a design chief and lead a design team.</p>
    </div>
  </div>
