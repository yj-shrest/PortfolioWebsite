...
const Project3 = () => {
  return (
    <div className="flex flex-col bg-[#fafafa] relative w-full md:w-[50rem] pb-10 h-auto space-y-4 md:space-y-2">
      <div className="flex w-full md:w-[40rem] items-end pb-2 space-x-2">
        <h1
        ...
        <h1 className="text-[1.35rem] sm:text-[2rem] font-semibold text-[#2f2f2f] leading-none">
          Automatic Exam Grading System
        </h1>
      </div>

      <div className="w-full md:w-[35rem] border-t-3 border-[#2D8BE8]"></div>
      <img
      ...
      <div className="flex space-x-2 w-full md:mt-[-17.7rem]">
        <img className="h-[3.25rem] sm:h-[4rem] object-contain" src="/PortfolioWebsite/opencv.png" alt="" />
        <img className="h-[3.25rem] sm:h-[4rem] object-contain" src="/PortfolioWebsite/mistral.png" alt="" />
      </div>
